...
### Research  
  - Bone metabolomics study in conjunction with the *AO research institute, Riga Traumatology and Orthopaedics Hospital, and the Baltic Biomaterials Center*. 
  - Sexual function during and after endometriosis treatment *(exploratory phase)*.

### Projects  
  - Building a Voron R2 3D printer.
  - Developing this website, with plans to expand it into a blog and project log.
  - Learning German to a C1 level.
...
- Automotive repair (engine, drivetrain) *-- current project an Audi TT mk2*.  
- Tinkering and hands-on building. 
- River kayaking *-- with plans to take on the coast*.
